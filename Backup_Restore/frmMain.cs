    ...
    public partial class frmMain : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (selectRowsArr.Length != 0 || checkBoxSTTBackup.Checked)
            {
                ...
                {
                    text = "Bạn muốn xóa tất cả các bản sao lưu trước khi sao lưu?";
                }
                ...
                {
                    {
                        ...
                        {
                            MessageBox.Show("Lỗi xóa các bản cập nhật đã chọn\n" + ex.Message, "LỖI", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    }
                }
            }
        ...
        {
            string cmd = "exec sp_addumpdevice 'disk', 'DEV_" + Program.dbName + "', 'C:\\Program Files\\Microsoft SQL Server\\MSSQL12.SERVER\\MSSQL\\Backup\\DEV_" + Program.dbName + ".bak'";
            try
            {
